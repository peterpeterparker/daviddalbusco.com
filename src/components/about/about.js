  ...
  render() {
    return <section className="about extraspace" id="about">
      <main className="small">
        ...
        <p>After my engineering degree, I spent many years collaborating on Java projects, which probably explains why I like to use <mark><a href="https://www.typescriptlang.org">Typescript</a></mark> and why I can understand backend developers 😉.</p>
        ...
        <p>If you have got a Web, Progressive Web Apps or mobile (iOS/Android) projects in mind, <mark><Link to="/#contact">get in touch!</Link></mark></p>
      </main>
    </section>
  }
}
