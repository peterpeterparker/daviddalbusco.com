...
8005 Zürich`}
        ...
        <footer className="opensource">
          <main className="small">
            <p>This website is open source. Its code is available on <a href="https://github.com/peterpeterparker/daviddalbusco.com">GitHub<FontAwesomeIcon icon={["fab", "github"]}/></a></p>
          </main>
        </footer>
      </>
  }
