...
class Post extends React.Component {
  ...
  renderPost() {
    if (this.props.node && this.props.node.frontmatter) {
      return (
        <Link to={this.props.node.frontmatter.path} className="post" aria-label={this.props.node.frontmatter.title}>
          <article>
            <div className="image">
            ...
            <div className="details">
              ...
              <p>
                {this.props.node.frontmatter.date} · {this.props.node.timeToRead} min read
              </p>
