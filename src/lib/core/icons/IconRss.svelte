<!-- source: https://fonts.google.com/icons?selected=Material+Icons+Round:rss_feed:&icon.size=24&icon.color=%23e3e3e3&icon.query=rss -->
<script lang="ts">
	interface Props {
		size: string;
	}
...
<svg
	...
	viewBox="0 0 24 24"
	fill="currentColor"
	><path d="M0 0h24v24H0V0z" fill="none" /><circle cx="6.18" cy="17.82" r="2.18" /><path
