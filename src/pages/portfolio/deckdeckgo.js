    ...
    return <Layout fixNav={true}>
      ...
      <section className="factsheet">
        <main>
          ...
          <p>The complexity of the project goes way beyond what is summarized above as each presentations written with
            DeckDeckGo are packaged and published online as self autonomous Progressive Web Apps. For such process we
            notably use <a href="https://aws.amazon.com/">Amazon AWS</a>, <a
              href="https://www.haskell.org/">Haskell</a>, <a href="https://nixos.org/nix/">Nix</a> and <a
              href="https://www.terraform.io/">Terraform</a>. All the credits for the implementation of this amazing
            tool chain goes to <a href="https://nmattia.com">Nicolas Mattia</a>.</p>
        </main>
      </section>
