            ...
            <article className="info">
              <div>
                <p>
                  ...
                  , a company by which I used to be employed, on a project
                  related to the commercial register ("Handelsregister" /
                  "Register du commerce").
                </p>
                <p>
                  DV Bern AG provides the most used ERP solution in Switzerland
                  for such administrations.
                </p>
                <p>
                  The project's scope was the development of a new process which
                  had an influence on both the online end clients of the
        ...
        <section className="factsheet">
          <main>
            ...
            <article>
              ...
              <div>
                <p>
                  <strong>Infrastructure:</strong> DV Bern AG provide its own
