      ...
      <Layout fixNav={true}>
            ...
            <article className="info">
              <div>
                <p>
                  ...
                  <a href="http://www.librarylab.ethz.ch" rel="noopener noreferrer">
                    ETH Library Lab
                  </a>
                  , an initiative for human-centered innovation in the knowledge sphere from{' '}
                ...
                <p>
                  The lab has for mission to help students, researchers and educators to unleash their full potential by boosting ideas that
                  support them in discovering, accessing, using or sharing scientific information and knowledge.
                </p>
                ...
                <ul>
                  ...
                  <li>support regarding the open source and prototyping concepts</li>
                </ul>
              </div>
            </article>
          </main>
        ...
        <section className="open-source">
          <main>
            ...
            <article>
              <p>
                The Lab seeks to advance tools, systems, practices and services and therefore will publish, at least, some projects and
                prototypes as open source softwares on{' '}
                <a href="https://github.com/eth-library-lab" rel="noopener noreferrer">
                  GitHub
