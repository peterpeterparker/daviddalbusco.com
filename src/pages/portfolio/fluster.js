          ...
          <main>
            ...
            <article className="info">
              <div>
                ...
                <p>
                  When I moved to Zürich I was struggling to find flat and
                  roommates, that's why I tried to develop my own platform to
                  help others and myself to solve such problems.
                </p>
                <p>
                  The startup itself failed but, it allowed me to become a
                  freelancer and to start my own company, therefore I consider
                  the all experience as a win.
                </p>
              </div>
        ...
        <section className="factsheet">
          <main>
            ...
            <article>
              <div>
                <p>
                  <strong>Discontinued:</strong> Used to be available as
                  Progressive Web Apps and in the Apple Store and Google Play
                </p>
                <p>
                  ...
                  and{" "}
                  <a
                    href="https://aws.amazon.com/fr/sns/"
                    rel="noopener noreferrer"
                  >
                    Amazon SNS
                  </a>
...
const FlusterPageQuery = () => (
  <StaticQuery
    query={graphql`
      query {
        flusterImage: file(
          relativePath: { eq: "portfolio/fluster-icon-pink.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 240) {
        ...
        flusterScreenshot1: file(
          relativePath: { eq: "portfolio/fluster/screenshot1.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
        ...
        flusterScreenshot2: file(
          relativePath: { eq: "portfolio/fluster/screenshot2.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
        ...
        flusterScreenshot3: file(
          relativePath: { eq: "portfolio/fluster/screenshot3.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
        ...
        flusterScreenshot4: file(
          relativePath: { eq: "portfolio/fluster/screenshot4.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
