            ...
            <article className="info">
              <div>
                <p>
                  ...
                  is a digital solution for the construction industry. It
                  automates the costing of materials and the creation of offers.
                </p>
                <p>
                  For this project, I took care of the frontend development of
                  the prototype which had for goal the creation of a simple
                  wizard (login > upload > edit > done) inspired by web-shops'
                  checkout process.
                </p>
                <p>
                  In addition to the development, I designed the UI of the
                  application too.
                </p>
              </div>
            </article>
