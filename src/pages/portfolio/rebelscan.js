        ...
        <section className="project extrabigspace">
          <main>
            ...
            <article className="info">
              <div>
                <p>
                  This last Christmas holidays, except visiting my parents for a couple of days, after having forced myself in a sort of
                  auto-lockdown period first, I did not have any big plans. That's why, I took the opportunity to improve my software
                ...
                <ol>
                  ...
                  <li>
                    ...
                    <a href="https://developer.mozilla.org/fr/docs/Web/API/MediaDevices/getUserMedia" rel="noopener noreferrer">
                  ...
                  <li>
                    ...
                    <a href="https://developer.mozilla.org/fr/docs/Web/API/Navigator/share" rel="noopener noreferrer">
                      Web Share
                    </a>{' '}
                    API
                  </li>
          ...
          <main>
            ...
            <article>
              <p>
                ...
                <a href="https://github.com/peterpeterparker/rebelscan" rel="noopener noreferrer">
                  GitHub
