            ...
            <article className="info">
              <div>
                <p>
                  ...
                  for the{" "}
                  <a
                    href="https://www.meetup.com/fr-FR/Ionic-Zurich/events/265767496/"
                    rel="noopener noreferrer"
                  >
                    Ionic Zürich Meetup
                  </a>{" "}
                ...
                <p>
                  Beside the pure joy of developing an app to browse doggos, it
                  also allowed me to try out the following features with{" "}
                  <a href="https://reactjs.org/" rel="noopener noreferrer">
                    React
                  </a>
                  : fetch API data with hooks, navigation, infinite scroll,
                  refresher, picker, toast, including and using a{" "}
                  ...
                  plugins share and storage, services worker to cache images and
                  continuous delivery with{" "}
                  <a
                    href="https://github.com/peterpeterparker/wooof/actions"
                    rel="noopener noreferrer"
                  >
                    GitHub Actions
                  </a>
            ...
            <article>
              ...
              <div>
                ...
                <p>
                  ...
                  and{" "}
                  <a
                    href="https://github.com/peterpeterparker/wooof/tree/master/.github/workflows"
                    rel="noopener noreferrer"
                  >
                    GitHub Actions
                  </a>
          ...
          <main>
            ...
            <article>
              <p>
                ...
                <a
                  href="https://github.com/peterpeterparker/wooof"
                  rel="noopener noreferrer"
                >
                  GitHub
  ...
  <StaticQuery
    query={graphql`
      query {
        ...
        wooofScreenshot1: file(
          relativePath: { eq: "portfolio/wooof/screenshot1.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
        ...
        wooofScreenshot2: file(
          relativePath: { eq: "portfolio/wooof/screenshot2.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
        ...
        wooofScreenshot3: file(
          relativePath: { eq: "portfolio/wooof/screenshot3.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
        ...
        wooofScreenshot4: file(
          relativePath: { eq: "portfolio/wooof/screenshot4.png" }
        ) {
          childImageSharp {
            fluid(maxWidth: 540) {
              ...GatsbyImageSharpFluid
