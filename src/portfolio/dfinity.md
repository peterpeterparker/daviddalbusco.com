...
The projects of the foundation are open source. Those to which I collaborated the most on GitHub are:
...
- [OISY Wallet Signer](https://github.com/dfinity/oisy-wallet-signer/): a lightweight library designed to connect dApps with the OISY Wallet, enabling secure message signing and transaction approvals.
