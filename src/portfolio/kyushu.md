...
This little project started as an experiment after giving a try to Cloudflare Workers. I thought: what if I replicated the concept, a single secure function, sandboxed, handling HTTP, but that can run on a VPS or anywhere without Node.js, Bun, or Docker.
...
And fun fact: this website is hosted on a VPS and run with Kyushu. 🌋🚀😎
